...
% Add Terrain Meshes
addTerrainMeshes(gridScene, featureVertices, weights, colors);

% Create Target
[targetPosition, roi] = createTarget(gridScene, weightedGrid, colors, gridSize);

% Initialize UAV and Sensors
...
waypointsVector = reshape(waypoints, [], 1); % Flatten the waypoints matrix
...
function addTerrainMeshes(gridScene, featureVertices, weights, colors)
